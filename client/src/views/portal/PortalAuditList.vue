<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 lg:p-6">
    ...
    <div v-else-if="audits.length === 0" class="bg-white dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-200 dark:border-gray-700">
      ...
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No audits found</h3>
      <p class="text-gray-600 dark:text-gray-400 mb-4">
        {{ hasFilters ? 'Try adjusting your filters' : 'Audits will appear here once they are available' }}
      </p>
      <button
        v-if="hasFilters"
        @click="resetFilters"
