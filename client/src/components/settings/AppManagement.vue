      ...
      >
        <div class="flex items-start justify-between">
          ...
          <div class="flex items-center gap-2 ml-4">
            ...
            <!-- Disable Button (hidden for CRM) -->
            <button
              v-if="app.status === 'ACTIVE' && app.appKey !== 'CRM'"
...
const appDescriptions = {
  CRM: 'Customer Relationship Management - Manage contacts, deals, and customer interactions.',
...
const allAppKeys = ['CRM', 'AUDIT', 'PORTAL'];
